...
int main()
{
    ...
    cout<<"Is chain valid? (Genesis Block)" << endl
    ...
    cout<<"Is the current chain valid? (New Block checking with new transaction data)" << endl
        << Ayushereum.isChainValid() << endl;
    ...
    cout<<"Is the current chain still valid? (Forcefully creating transaction data)"<< endl
        <<Ayushereum.isChainValid() << endl;
